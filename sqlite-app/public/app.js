...
function currentRows(){
  ...
  // Sub-tab: show tasks of this type PLUS any with a blank type (older tasks that
  // predate the Type field appear under both Ad-hoc and Routine).
  if(currentType !== "all") rows = rows.filter(r => { const ty = (r.type||"").trim(); return ty === currentType || ty === ""; });
